 ...
 */
final class Version20211026105240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE label (id INT AUTO_INCREMENT NOT NULL, language_id INT NOT NULL, vocabulary_id INT NOT NULL, tag VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, version VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_EA750E882F1BAF4 (language_id), INDEX IDX_EA750E8AD0E05F6 (vocabulary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE label_tag (label_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_376BEE3733B92F39 (label_id), INDEX IDX_376BEE37BAD26311 (tag_id), PRIMARY KEY(label_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, external_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', external_system_id INT NOT NULL, version INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, vocabulary_id INT NOT NULL, type_id INT NOT NULL, name VARCHAR(255) NOT NULL, version VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_389B783AD0E05F6 (vocabulary_id), INDEX IDX_389B783C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
