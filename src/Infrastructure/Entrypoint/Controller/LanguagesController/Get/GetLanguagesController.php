...
namespace XTags\Infrastructure\Entrypoint\Controller\LanguagesController\Get;
...
class GetLanguagesController extends AbstractController
{    
    use HandleTrait;
